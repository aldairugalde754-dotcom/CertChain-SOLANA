...
import { St as init_index_browser_esm, j as PublicKey, mt as VersionedTransaction, nt as Transaction, p as Connection, pt as VersionedMessage } from "./index.browser.esm-DgciGOZ7.js";
import { c as WalletReadyState, i as BaseSignInMessageSignerWalletAdapter, n as createSignInMessageText, o as isVersionedTransaction$1, s as BaseWalletAdapter } from "./signIn-o8Cn3WN_.js";
import { a as WalletDisconnectionError, c as WalletNotConnectedError, d as WalletSendTransactionError, f as WalletSignInError, i as WalletDisconnectedError, l as WalletNotReadyError, m as WalletSignTransactionError, n as WalletConfigError, o as WalletError, p as WalletSignMessageError, r as WalletConnectionError, t as WalletAccountError, u as WalletPublicKeyError } from "./errors-CGaecrVV.js";
...
var SolanaErrorMessages = {
	...
	[4]: "Expected base58-encoded blockhash string of length in the range [32, 44]. Actual length: $actualLength.",
...
//#endregion
//#region node_modules/@solana/kit/node_modules/@solana/codecs-core/dist/index.browser.mjs
...
//#endregion
//#region node_modules/@solana/kit/node_modules/@solana/codecs-strings/dist/index.browser.mjs
...
var getBase64Decoder = () => {
	return createDecoder({ read(bytes, offset = 0) {
		const slice = bytes.slice(offset);
		return [btoa(String.fromCharCode(...slice)), bytes.length];
	} });
};
var removeNullCharacters = (value) => value.replace(/\u0000/g, "");
var e$5 = globalThis.TextDecoder;
var o$10 = globalThis.TextEncoder;
var getUtf8Encoder = () => {
	let textEncoder;
	return createEncoder({
		getSizeFromValue: (value) => (textEncoder ||= new o$10()).encode(value).length,
		write: (value, bytes, offset) => {
			const bytesToAdd = (textEncoder ||= new o$10()).encode(value);
			bytes.set(bytesToAdd, offset);
			return offset + bytesToAdd.length;
		}
	});
...
var getUtf8Decoder = () => {
	...
	return createDecoder({ read(bytes, offset) {
		return [removeNullCharacters((textDecoder ||= new e$5()).decode(bytes.slice(offset))), bytes.length];
	} });
};
globalThis.TextDecoder;
globalThis.TextEncoder;
...
//#endregion
//#region node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/esm/index.browser.js
...
function createDefaultChainSelector() {
	return { async select(chains) {
		...
		else if (chains.includes("solana:mainnet")) return SOLANA_MAINNET_CHAIN;
...
var SolanaMobileWalletAdapterWalletName$1 = "Mobile Wallet Adapter";
...
var LocalSolanaMobileWalletAdapterWallet = class {
	#listeners = {};
	#version = "1.0.0";
	#name = SolanaMobileWalletAdapterWalletName$1;
	...
	*/
	...
	#connect = async ({ silent } = {}) => {
		...
		try {
			...
			throw new Error(getErrorMessage$1(e), { cause: e });
		} finally {
	...
	#handleWalletCapabilitiesResult = async (capabilities) => {
		...
		const didCapabilitiesChange = "solana:signAndSendTransaction" in this.features !== supportsSignAndSendTransaction || "solana:signTransaction" in this.features !== supportsSignTransaction;
		this.#optionalFeatures = {
			...(supportsSignAndSendTransaction || !supportsSignAndSendTransaction && !supportsSignTransaction) && { ["solana:signAndSendTransaction"]: {
				version: "1.0.0",
				supportedTransactionVersions: ["legacy", 0],
				signAndSendTransaction: this.#signAndSendTransaction
			} },
			...supportsSignTransaction && { ["solana:signTransaction"]: {
				version: "1.0.0",
				supportedTransactionVersions: ["legacy", 0],
				signTransaction: this.#signTransaction
			} }
...
//#endregion
//#region node_modules/@solana-mobile/wallet-adapter-mobile/lib/esm/index.browser.js
init_index_browser_esm();
function getIsSupported() {
	return typeof window !== "undefined" && window.isSecureContext && typeof document !== "undefined" && /android/i.test(navigator.userAgent);
}
var SolanaMobileWalletAdapterWalletName = SolanaMobileWalletAdapterWalletName$1;
...
var BaseSolanaMobileWalletAdapter = class extends BaseSignInMessageSignerWalletAdapter {
	...
	async #performSignTransactions(transactions) {
		const account = this.#assertIsAuthorized();
		try {
			if ("solana:signTransaction" in this.#wallet.features) return this.#wallet.features[SolanaSignTransaction].signTransaction(...transactions.map((value) => {
				return {
					account,
...
//#endregion
//#region node_modules/@solana/wallet-standard-wallet-adapter-react/node_modules/base-x/src/esm/index.js
	...
	try {
		...
		try {
			const serializedTransaction = (await __classPrivateFieldGet(this, _StandardWalletAdapter_wallet, "f").features[SolanaSignTransaction].signTransaction({
				account,
				transaction: isVersionedTransaction$1(transaction) ? transaction.serialize() : new Uint8Array(transaction.serialize({
					requireAllSignatures: false,
					verifySignatures: false
				}))
			}))[0].signedTransaction;
			return isVersionedTransaction$1(transaction) ? VersionedTransaction.deserialize(serializedTransaction) : Transaction.from(serializedTransaction);
		} catch (error) {
			if (error instanceof WalletError) throw error;
	...
	try {
		...
		try {
			...
			return transactions.map((transaction, index) => {
				...
				return isVersionedTransaction$1(transaction) ? VersionedTransaction.deserialize(signedTransaction) : Transaction.from(signedTransaction);
			});
		} catch (error) {
			throw new WalletSignTransactionError(error?.message, error);
		}
...
//#endregion
export { useWallet as a, ConnectionContext as c, WalletContext as i, useConnection as l, useLocalStorage as n, WalletNotSelectedError as o, useAnchorWallet as r, ConnectionProvider as s, WalletProvider as t };

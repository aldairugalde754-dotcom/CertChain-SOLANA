import { n as __esmMin, o as __toCommonJS, r as __exportAll, s as __toESM, t as __commonJSMin } from "./rolldown-runtime-BzI350Cx.js";
...
var _0n$5, _1n$5, _2n$5, _3n$1, _4n$1, _5n$1, _7n$1, _8n$2, _9n, _16n, isNegativeLE, FIELD_FIELDS;
...
var _0n$2, _1n$2, _2n$3, _5n, _8n, ed25519_CURVE_p, ed25519_CURVE, ED25519_SQRT_M1, Fp, Fn, ed25519Defaults, ed25519, SQRT_M1, SQRT_AD_MINUS_ONE, INVSQRT_A_MINUS_D, ONE_MINUS_D_SQ, D_MINUS_ONE_SQ, invertSqrt, MAX_255B, bytes255ToNumberLE, _RistrettoPoint;
var init_ed25519 = __esmMin((() => {
	init_sha2();
	init_utils$1();
	init_curve();
	init_edwards();
	...
	invertSqrt = (number) => uvRatio(_1n$2, number);
...
var require_bn = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(module$1, exports$1) {
		...
		try {
			...
			else Buffer = require_buffer().Buffer;
		} catch (e) {}
...
var init_index_browser$2 = __esmMin((() => {
...
var init_index_browser$1 = __esmMin((() => {
	init_index_browser$3();
...
//#endregion
//#region node_modules/@solana/web3.js/node_modules/superstruct/dist/index.mjs
/**
...
//#endregion
//#region node_modules/rpc-websockets/node_modules/eventemitter3/index.js
...
var index_browser_esm_exports = /* @__PURE__ */ __exportAll({
	Account: () => Account,
...
async function sendAndConfirmRawTransaction(connection, rawTransaction, confirmationStrategyOrConfirmOptions, maybeConfirmOptions) {
	...
	const status = (await (confirmationStrategy ? connection.confirmTransaction(confirmationStrategy, commitment) : connection.confirmTransaction(signature, commitment))).value;
	if (status.err) {
		if (signature != null) throw new SendTransactionError({
...
var init_index_browser_esm = __esmMin((() => {
	...
	PublicKey = class PublicKey extends Struct {
		...
		*/
		static async createWithSeed(fromPublicKey, seed, programId) {
			const publicKeyBytes = sha256(import_buffer.Buffer.concat([
		...
		*/
		static createProgramAddressSync(seeds, programId) {
			...
			buffer = import_buffer.Buffer.concat([
				buffer,
				programId.toBuffer(),
	...
	rustString = (property = "string") => {
		...
		rslShim.encode = (str, b, offset) => {
			const data = { chars: import_buffer.Buffer.from(str, "utf8") };
	...
	TransactionStatus = /*#__PURE__*/ function(TransactionStatus) {
	...
	VersionedTransaction = class VersionedTransaction {
		...
		constructor(message, signatures) {
			...
			if (signatures !== void 0) {
				...
				for (let i = 0; i < message.header.numRequiredSignatures; i++) defaultSignatures.push(/* @__PURE__ */ new Uint8Array(64));
		...
		serialize() {
			...
			const serializedTransaction = /* @__PURE__ */ new Uint8Array(2048);
		...
		static deserialize(serializedTransaction) {
			...
			for (let i = 0; i < signaturesLength; i++) signatures.push(new Uint8Array(guardedSplice(byteArray, 0, 64)));
		...
		addSignature(publicKey, signature) {
			...
			const signerIndex = this.message.staticAccountKeys.slice(0, this.message.header.numRequiredSignatures).findIndex((pubkey) => pubkey.equals(publicKey));
		...
		*/
		static async load(connection, payer, program, programId, data) {
			...
			while (array.length > 0) {
				...
				const data = import_buffer.Buffer.alloc(chunkSize + 16);
				dataLayout.encode({
					instruction: 0,
					offset,
					bytes,
			...
			await Promise.all(transactions);
			{
				...
				const data = import_buffer.Buffer.alloc(dataLayout.span);
		...
		*/
		async simulateTransaction(transactionOrMessage, configOrSigners, includeAccounts) {
			if ("message" in transactionOrMessage) {
				...
				const encodedTransaction = import_buffer.Buffer.from(wireTransaction).toString("base64");
 ...
 /**
	...
	Secp256k1Program = class Secp256k1Program {
		...
		*/
		static publicKeyToEthAddress(publicKey) {
			...
			try {
				return import_buffer.Buffer.from(keccak_256(toBuffer(publicKey))).slice(-20);
			} catch (error) {
	...
	*/
	...
	ValidatorInfo = class ValidatorInfo {
		...
		*/
		static fromConfigData(buffer) {
			...
			const configKeys = [];
			for (let i = 0; i < 2; i++) {
				const publicKey = new PublicKey(guardedSplice(byteArray, 0, 32));
	...
	VoteAccount = class VoteAccount {
		...
		*/
		static fromAccountData(buffer) {
			const va = VoteAccountLayout.decode(toBuffer(buffer), 4);

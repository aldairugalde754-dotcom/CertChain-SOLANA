...
import { St as init_index_browser_esm, j as PublicKey, nt as Transaction } from "./index.browser.esm-DgciGOZ7.js";
import { c as WalletNotConnectedError, m as WalletSignTransactionError, o as WalletError, p as WalletSignMessageError, r as WalletConnectionError, u as WalletPublicKeyError } from "./errors-CGaecrVV.js";
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/core/types.js
var PopupEvent;
(function(PopupEvent) {
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/core/connection.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/core/utils.js
function validateOrigin(origin) {
	return origin === "https://www.fractal.is" || origin === "https://fractal.is";
}
var TARGET = "fractal:approval:popup";
var STATIC_POPUP_FEATURES = [
	"resizable",
	"scrollbars=1",
	"status=1"
];
function openPopup({ left = 0, scope = window, top = 0, width = 600, height = 600, url }) {
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/connection-manager.js
var ConnectionManager = class {
	...
	async open({ url, widthPx = 400, heightPx = 600, nonce }) {
		var _a;
		...
		if (url instanceof Promise) this.setUrl(await url);
	}
	close() {
		if (!this.popupWindow) return;
	...
	verifyAndResetNonce(uncheckedNonce) {
		...
		if (result) this.nonce = void 0;
		return result;
	}
};
require_react();
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/lib/guards.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/payloads/solana-wallet-adapter-approved.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/payloads/transaction-signature-needed-response.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/@fractalwagmi/popup-connection/dist/esm/payloads/message-signature-needed-response.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/base-x/src/index.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/node_modules/bs58/index.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/dist/esm/core/nonce.js
...
//#endregion
//#region node_modules/@fractalwagmi/solana-wallet-adapter/dist/esm/core/fractal-wallet-adapter-impl.js
var UNKNOWN_ERROR_MESSAGE = "Unknown Error";
var FRACTAL_DOMAIN_HTTPS = "https://fractal.is";
var APPROVE_PAGE_URL = `${FRACTAL_DOMAIN_HTTPS}/wallet-adapter/approve`;
var SIGN_PAGE_URL = `${FRACTAL_DOMAIN_HTTPS}/wallet-adapter/sign`;
var SIGN_MESSAGE_PAGE_URL = `${FRACTAL_DOMAIN_HTTPS}/wallet-adapter/sign/message`;
var MIN_POPUP_HEIGHT_PX = 600;
...
var FractalWalletAdapterImpl = class {
	...
	async signTransaction(transaction) {
		try {
			...
			return (await this.signTransactions([transaction]))[0];
		} catch (error) {
			let errorToThrow = error;
			if (!(error instanceof WalletError)) errorToThrow = new WalletSignTransactionError(error instanceof Error ? error.message : UNKNOWN_ERROR_MESSAGE, error);
			throw errorToThrow;
		}
	}
	async signAllTransactions(transactions) {
		try {
			this.checkWalletReadiness();
			return await this.signTransactions(transactions);
		} catch (error) {
			let errorToThrow = error;
			if (!(error instanceof WalletError)) errorToThrow = new WalletSignTransactionError(error instanceof Error ? error.message : UNKNOWN_ERROR_MESSAGE, error);
			throw errorToThrow;
	...
	async signMessage(encodedMessage) {
		...
		const nonce = createNonce();
		this.popupManager.open({
			heightPx: Math.max(MIN_POPUP_HEIGHT_PX, Math.floor(window.innerHeight * .8)),
			nonce,
			url: `${SIGN_MESSAGE_PAGE_URL}/${nonce}`,
			widthPx: Math.min(MAX_POPUP_WIDTH_PX, Math.floor(window.innerWidth * .8))
		});
		this.popupManager.onConnectionUpdated((connection) => {
			if (!connection) return;
	...
	async signTransactions(transactions) {
		...
		const handleAuthLoaded = () => {
			var _a;
			const payload = { unsignedB58Transactions: transactions.map((t) => import_bs58.default.encode(t.serializeMessage())) };
			(_a = this.popupManager.getConnection()) === null || _a === void 0 || _a.send({
	...
	checkWalletReadiness() {
		if (this.publicKey === null) throw new WalletNotConnectedError("`publicKey` is null. Did you forget to call `.connect()`?");
	}
};
//#endregion
export { FractalWalletAdapterImpl };

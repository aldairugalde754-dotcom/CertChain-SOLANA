...
//#region node_modules/get-size/get-size.js
...
//#endregion
//#region node_modules/unidragger/unidragger.js
var require_unidragger = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* Unidragger v3.0.1
	...
	*/
	(function(window, factory) {
		...
		else window.Unidragger = factory(window, window.EvEmitter);
		...
		*/
		proto.pointerDown = function(event, pointer) {
			...
			if (!(!this.isPointerDown && !event.button && isOkayElement)) return;
		...
		proto.pointerMove = function(event, pointer) {
			...
			if (!this.isDragging && this.hasDragStarted(moveVector)) this.dragStart(event, pointer);
		...
		proto.pointerUp = function(event, pointer) {
			...
			else this.staticClick(event, pointer);
		};
...
//#endregion
//#region node_modules/draggabilly/draggabilly.js
var require_draggabilly = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* Draggabilly v3.0.0
	...
	*/
	(function(window, factory) {
		if (typeof module == "object" && module.exports) module.exports = factory(window, require_get_size(), require_unidragger());
		else window.Draggabilly = factory(window, window.getSize, window.Unidragger);
	})(typeof window != "undefined" ? window : exports, function factory(window, getSize, Unidragger) {
		function noop() {}
		...
		*/
		...
		proto._create = function() {
			...
			if (!positionValues.includes(style.position)) this.element.style.position = "relative";
		...
		proto.setHandles = function() {
			...
			if (typeof handle == "string") this.handles = this.element.querySelectorAll(handle);
			else if (typeof handle == "object" && handle.length) this.handles = handle;
			else if (handle instanceof HTMLElement) this.handles = [handle];
			else this.handles = [this.element];
		};
		...
		proto.emitEvent = function(eventName, args) {
			...
			let event;
			let jqArgs = args;
			if (args && args[0] instanceof Event) [event, ...jqArgs] = args;
		...
		proto.getContainer = function() {
			...
			if (containment instanceof HTMLElement) return containment;
		...
		*/
		...
		proto._init = noop;
		if (jQuery && jQuery.bridget) jQuery.bridget("draggabilly", Draggabilly);
		return Draggabilly;
	});
}));
//#endregion

...
export declare function mintToCollectionV1(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: MintToCollectionV1InstructionAccounts & MintToCollectionV1InstructionArgs): TransactionBuilder;

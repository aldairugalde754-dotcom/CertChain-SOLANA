...
exports.createTreeConfigV2 = exports.getCreateTreeConfigV2InstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getCreateTreeConfigV2InstructionDataSerializer() {
    ...
    ], { description: 'CreateTreeConfigV2InstructionData' }), (value) => ({
        ...value,
        discriminator: [55, 99, 95, 215, 142, 203, 227, 205],
        public: value.public ?? (0, umi_1.none)(),
    }));
}
exports.getCreateTreeConfigV2InstructionDataSerializer = getCreateTreeConfigV2InstructionDataSerializer;
// Instruction.
function createTreeConfigV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getCreateTreeConfigV2InstructionDataSerializer().serialize(resolvedArgs);
    // Bytes Created On Chain.
    const bytesCreatedOnChain = 96 + umi_1.ACCOUNT_HEADER_SIZE;
    return (0, umi_1.transactionBuilder)([
        { instruction: { keys, programId, data }, signers, bytesCreatedOnChain },
    ]);
}
exports.createTreeConfigV2 = createTreeConfigV2;
//# sourceMappingURL=createTreeConfigV2.js.map
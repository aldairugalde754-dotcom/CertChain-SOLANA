...
export declare function verifyCollection(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: VerifyCollectionInstructionAccounts & VerifyCollectionInstructionArgs): TransactionBuilder;

...
export declare class CollectionMustHaveRoyaltiesPluginError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}
/** InheritedSellerFeeCannotHaveLeafCreators: Inherited seller fee basis points cannot be used with leaf-level creators */
export declare class InheritedSellerFeeCannotHaveLeafCreatorsError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}
...
export declare class CannotRemoveFromCollectionWithInheritedSellerFeeError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}

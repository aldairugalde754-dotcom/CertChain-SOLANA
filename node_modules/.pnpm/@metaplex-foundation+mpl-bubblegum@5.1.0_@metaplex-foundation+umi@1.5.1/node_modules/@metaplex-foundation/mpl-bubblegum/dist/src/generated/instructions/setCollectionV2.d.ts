...
export declare function getSetCollectionV2InstructionDataSerializer(): Serializer<SetCollectionV2InstructionDataArgs, SetCollectionV2InstructionData>;
export type SetCollectionV2InstructionExtraArgs = {
    proof?: Array<PublicKey>;
};
export type SetCollectionV2InstructionArgs = PickPartial<SetCollectionV2InstructionDataArgs & SetCollectionV2InstructionExtraArgs, 'proof'>;
export declare function setCollectionV2(context: Pick<Context, 'eddsa' | 'payer' | 'programs'>, input: SetCollectionV2InstructionAccounts & SetCollectionV2InstructionArgs): TransactionBuilder;

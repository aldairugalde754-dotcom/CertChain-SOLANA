...
exports.getMplBubblegumErrorFromName = exports.getMplBubblegumErrorFromCode = exports.CannotRemoveFromCollectionWithInheritedSellerFeeError = exports.InheritedSellerFeeCannotHaveLeafCreatorsError = exports.CollectionMustHaveRoyaltiesPluginError = exports.AssetIsNotFrozenError = exports.MissingMplCoreCpiSignerAccountError = exports.AlreadyNotInCollectionError = exports.AlreadyInCollectionError = exports.AssetDataLengthTooLongError = exports.MissingCollectionAccountError = exports.NotAvailableError = void 0;
...
class CollectionMustHaveRoyaltiesPluginError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Core collections must have the Royalties plugin to inherit seller fee basis points', program, cause);
        this.name = 'CollectionMustHaveRoyaltiesPlugin';
        this.code = 0x17a9; // 6057
    }
}
exports.CollectionMustHaveRoyaltiesPluginError = CollectionMustHaveRoyaltiesPluginError;
codeToErrorMap.set(0x17a9, CollectionMustHaveRoyaltiesPluginError);
nameToErrorMap.set('CollectionMustHaveRoyaltiesPlugin', CollectionMustHaveRoyaltiesPluginError);
/** InheritedSellerFeeCannotHaveLeafCreators: Inherited seller fee basis points cannot be used with leaf-level creators */
class InheritedSellerFeeCannotHaveLeafCreatorsError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Inherited seller fee basis points cannot be used with leaf-level creators', program, cause);
        this.name = 'InheritedSellerFeeCannotHaveLeafCreators';
        this.code = 0x17aa; // 6058
    }
}
exports.InheritedSellerFeeCannotHaveLeafCreatorsError = InheritedSellerFeeCannotHaveLeafCreatorsError;
codeToErrorMap.set(0x17aa, InheritedSellerFeeCannotHaveLeafCreatorsError);
nameToErrorMap.set('InheritedSellerFeeCannotHaveLeafCreators', InheritedSellerFeeCannotHaveLeafCreatorsError);
...
class CannotRemoveFromCollectionWithInheritedSellerFeeError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Cannot remove from collection while seller fee basis points are inherited', program, cause);
        this.name = 'CannotRemoveFromCollectionWithInheritedSellerFee';
        this.code = 0x17ab; // 6059
    }
}
exports.CannotRemoveFromCollectionWithInheritedSellerFeeError = CannotRemoveFromCollectionWithInheritedSellerFeeError;
codeToErrorMap.set(0x17ab, CannotRemoveFromCollectionWithInheritedSellerFeeError);
nameToErrorMap.set('CannotRemoveFromCollectionWithInheritedSellerFee', CannotRemoveFromCollectionWithInheritedSellerFeeError);
/**

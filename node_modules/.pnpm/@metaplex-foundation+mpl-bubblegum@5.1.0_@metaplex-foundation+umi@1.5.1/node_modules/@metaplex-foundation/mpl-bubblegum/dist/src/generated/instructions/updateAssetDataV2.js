...
function getUpdateAssetDataV2InstructionDataSerializer() {
    ...
    ], { description: 'UpdateAssetDataV2InstructionData' }), (value) => ({
        ...value,
        discriminator: [59, 56, 111, 43, 95, 14, 11, 61],
        previousAssetDataHash: value.previousAssetDataHash ?? (0, umi_1.none)(),
        flags: value.flags ?? (0, umi_1.none)(),
        newAssetData: value.newAssetData ?? (0, umi_1.none)(),
        newAssetDataSchema: value.newAssetDataSchema ?? (0, umi_1.none)(),
    }));
}

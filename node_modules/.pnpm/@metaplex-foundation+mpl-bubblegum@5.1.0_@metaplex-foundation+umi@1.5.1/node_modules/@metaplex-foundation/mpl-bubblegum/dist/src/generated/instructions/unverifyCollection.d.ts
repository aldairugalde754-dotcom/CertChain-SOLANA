...
export declare function unverifyCollection(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: UnverifyCollectionInstructionAccounts & UnverifyCollectionInstructionArgs): TransactionBuilder;

...
export declare function getUnverifyCreatorV2InstructionDataSerializer(): Serializer<UnverifyCreatorV2InstructionDataArgs, UnverifyCreatorV2InstructionData>;
export type UnverifyCreatorV2InstructionExtraArgs = {
    proof?: Array<PublicKey>;
};
export type UnverifyCreatorV2InstructionArgs = PickPartial<UnverifyCreatorV2InstructionDataArgs & UnverifyCreatorV2InstructionExtraArgs, 'proof'>;
export declare function unverifyCreatorV2(context: Pick<Context, 'eddsa' | 'payer' | 'programs'>, input: UnverifyCreatorV2InstructionAccounts & UnverifyCreatorV2InstructionArgs): TransactionBuilder;

 ...
 */
export declare const getMerkleRoot: (leaves: PublicKey[], maxDepth: number) => PublicKey;
/**
 ...
 */
export declare const getMerkleProof: (leaves: PublicKey[], maxDepth: number, leaf: PublicKey, index?: number) => PublicKey[];
/**
 ...
 */
export declare const getMerkleProofAtIndex: (leaves: PublicKey[], maxDepth: number, index: number) => PublicKey[];

...
exports.delegateAndFreezeV2 = exports.getDelegateAndFreezeV2InstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getDelegateAndFreezeV2InstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        ['collectionHash', (0, serializers_1.option)((0, serializers_1.bytes)({ size: 32 }))],
        ['assetDataHash', (0, serializers_1.option)((0, serializers_1.bytes)({ size: 32 }))],
        ['flags', (0, serializers_1.option)((0, serializers_1.u8)())],
        ['nonce', (0, serializers_1.u64)()],
        ['index', (0, serializers_1.u32)()],
    ], { description: 'DelegateAndFreezeV2InstructionData' }), (value) => ({
        ...value,
        discriminator: [17, 229, 35, 218, 190, 241, 250, 123],
        collectionHash: value.collectionHash ?? (0, umi_1.none)(),
        assetDataHash: value.assetDataHash ?? (0, umi_1.none)(),
        flags: value.flags ?? (0, umi_1.none)(),
    }));
}
exports.getDelegateAndFreezeV2InstructionDataSerializer = getDelegateAndFreezeV2InstructionDataSerializer;
// Instruction.
function delegateAndFreezeV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getDelegateAndFreezeV2InstructionDataSerializer().serialize(resolvedArgs);
...
exports.delegateAndFreezeV2 = delegateAndFreezeV2;
//# sourceMappingURL=delegateAndFreezeV2.js.map
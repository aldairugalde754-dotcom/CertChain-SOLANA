...
export type TransferV2InstructionAccounts = {
...
export declare function getTransferV2InstructionDataSerializer(): Serializer<TransferV2InstructionDataArgs, TransferV2InstructionData>;
export type TransferV2InstructionExtraArgs = {
    proof?: Array<PublicKey>;
};
export type TransferV2InstructionArgs = PickPartial<TransferV2InstructionDataArgs & TransferV2InstructionExtraArgs, 'proof'>;
export declare function transferV2(context: Pick<Context, 'eddsa' | 'payer' | 'programs'>, input: TransferV2InstructionAccounts & TransferV2InstructionArgs): TransactionBuilder;

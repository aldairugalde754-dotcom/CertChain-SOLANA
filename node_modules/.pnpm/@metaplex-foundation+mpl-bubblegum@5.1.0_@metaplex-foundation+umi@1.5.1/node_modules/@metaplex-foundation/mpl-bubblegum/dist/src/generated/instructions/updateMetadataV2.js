...
exports.updateMetadataV2 = exports.getUpdateMetadataV2InstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getUpdateMetadataV2InstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        ['currentMetadata', (0, types_1.getMetadataArgsV2Serializer)()],
        ['updateArgs', (0, types_1.getUpdateArgsSerializer)()],
    ], { description: 'UpdateMetadataV2InstructionData' }), (value) => ({
        ...value,
...
exports.getUpdateMetadataV2InstructionDataSerializer = getUpdateMetadataV2InstructionDataSerializer;
// Instruction.
function updateMetadataV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getUpdateMetadataV2InstructionDataSerializer().serialize(resolvedArgs);

...
export declare function unverifyCreator(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: UnverifyCreatorInstructionAccounts & UnverifyCreatorInstructionArgs): TransactionBuilder;
